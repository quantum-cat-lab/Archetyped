...
#define SQLITE_CREATE_VTABLE        29   /* Table Name      ModuleInstance Name     */
#define SQLITE_DROP_VTABLE          30   /* Table Name      ModuleInstance Name     */
...
** ^ModuleInstance names must be registered before
...
SQLITE_API int sqlite3_create_module_v2(
  ...
  const sqlite3_module *p,   /* Methods for the module */
  void *pClientData,         /* Client data for xCreate/xConnect */
  void(*xDestroy)(void*)     /* ModuleInstance destructor function */
);
